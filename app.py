...
TRANSLATIONS = {
    "zh-Hant": {
        ...
        "upload.progress_title": "上傳進度",
        "upload.progress_preparing": "正在準備上傳",
        "upload.progress_uploading": "正在上傳 MP4",
        "upload.progress_uploaded": "MP4 上傳完成，準備開始轉文字",
        "upload.progress_failed": "MP4 上傳失敗",
        "video.author": "作者：",
        "video.source": "影片網址",
        ...
        "burn.settings_font_family_swei_fan": "獅尾繁中黑體",
    ...
    "zh-Hans": {
        ...
        "upload.progress_title": "上传进度",
        "upload.progress_preparing": "正在准备上传",
        "upload.progress_uploading": "正在上传 MP4",
        "upload.progress_uploaded": "MP4 上传完成，准备开始转文字",
        "upload.progress_failed": "MP4 上传失败",
        "video.author": "作者：",
        "video.source": "视频网址",
        ...
        "burn.settings_font_family_swei_fan": "狮尾繁中黑体",
    ...
    "en": {
        ...
        "upload.progress_title": "Upload Progress",
        "upload.progress_preparing": "Preparing upload",
        "upload.progress_uploading": "Uploading MP4",
        "upload.progress_uploaded": "MP4 uploaded, starting transcription",
        "upload.progress_failed": "MP4 upload failed",
        "video.author": "Author:",
        ...
        "burn.settings_font_family_swei_fan": "Swei Fan Sans",
    ...
    "ja": {
        ...
        "upload.progress_title": "アップロード進捗",
        "upload.progress_preparing": "アップロードを準備中",
        "upload.progress_uploading": "MP4 をアップロード中",
        "upload.progress_uploaded": "MP4 のアップロード完了、文字起こしを開始します",
        "upload.progress_failed": "MP4 のアップロードに失敗しました",
        "video.author": "作者：",
        "video.source": "動画URL",
